    ...
    for (pi = r->pos; pi < r->last; pi++) {
        ...
        switch (state) {
            ...
            case sw_start:
                ...
                if ((ch < 'A' || ch > 'Z') && ch != '_') {
                    return BF_HTTP_PARSE_INVALID_METHOD;
                }
            ...
            case sw_method:
                if (ch == ' ') {
                    ...
                    switch (p - m) {
                        case 3:
                            if (bf_str3_cmp(m, 'G', 'E', 'T', ' ')) {
                                r->method = BF_HTTP_GET;
                                break;
                            }
                        ...
                        case 4:
                            if (bf_str4cmp(m, 'H', 'E', 'A', 'D')) {
                                r->method = BF_HTTP_HEAD;
                                break;
                            }

                            break;
                        default:
                            r->method = BF_HTTP_UNKNOWN;
                            break;
                    }
            ...
            case sw_spaces_before_uri:
                ...
                switch (ch) {
                    case ' ':
                        break;
                    default:
                        return BF_HTTP_PARSE_INVALID_REQUEST;
                }
                break;
        ...
        switch (state) {
            ...
            case sw_spaces_before_colon:
                if (ch == ' ') {
                    ...
                    return BF_HTTP_PARSE_INVALID_HEADER;
                }
            ...
            case sw_cr:
                if (ch == LF) {
                    ...
                    hd = (bf_header_t *) malloc(sizeof(bf_header_t));
